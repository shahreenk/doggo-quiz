const RANDOM_IMG_ENDPOINT = "https://dog.ceo/api/breeds/image/random";
    ...
    function getMultipleChoices(n, correctAnswer, possibleChoices) {
        ...
        while (choices.length < n) {
            let possibility = getRandomElement(possibleChoices);
            if (!choices.includes(possibility)) {
    ...
    function getBreedFromURL(url) {
        ...
        const [,,,,dogBreedParameter] = url.split("/");
        const dogBreed = dogBreedParameter.includes('-') ? dogBreedParameter.split('-').reverse().join(' ') : dogBreedParameter;
        return dogBreed;
    }
